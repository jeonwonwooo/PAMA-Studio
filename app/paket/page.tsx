...
const packages: PackageData[] = [
  // ... (Data array packages kamu biarkan sama persis seperti aslinya)
  {
    ...
    subPackages: [
      { name: "Duo", description: "Paket untuk 1-2 orang, 10 menit sesi, 1 print 4R", price: "Rp 40.000" },
      { name: "Basic", description: "Paket 1-3 orang, 15 menit sesi, 1 print 4R", price: "Rp 50.000" },
      { name: "Square", description: "Paket 2-4 orang, 15 menit, 2 print 4R", price: "Rp 65.000" },
      { name: "Group", description: "Paket 3-6 orang, 15 menit, 3 print 4R", price: "Rp 85.000" },
      { name: "Full Team", description: "Paket 4-8 orang, 15 menit, 4 print 4R", price: "Rp 110.000" },
    ],
    additionals: [
      { name: "Time", price: "Rp 15.000" },
      { name: "Person", price: "Rp 10.000" },
      { name: "Print 4R", price: "Rp 10.000" },
      { name: "Onesie", price: "Rp 10.000" },
    ],
  ...
  },
  {
    ...
    subPackages: [
      { name: "Star", description: "Paket untuk 1-3 orang, 20 menit sesi, 1 print 4R", price: "Rp 40.000" },
      { name: "Aurora", description: "Paket untuk 2-4 orang, 20 menit sesi, 2 print 4R", price: "Rp 50.000" },
      { name: "Eclipse", description: "Paket untuk 3-6 orang, 20 menit sesi, 3 print 4R", price: "Rp 65.000" },
      { name: "Orion", description: "Paket untuk 4-8 orang, 20 menit sesi, 4 print 4R", price: "Rp 85.000" },
    ],

    additionals: [
      { name: "Time 5 menit", price: "Rp 15.000" },
      { name: "Person", price: "Rp 10.000" },
      { name: "Print 4R", price: "Rp 10.000" },
      { name: "Onesie", price: "Rp 10.000" },
      { name: "Sofa per sesi", price: "Rp 25.000" },
    ],
    ...
    galleryImages: ["/images/foto7.jpg", "/images/foto8.jpg", "/images/foto9.jpg", "/images/foto10.jpg"],
    subPackages: [
      { name: "Star", description: "Paket untuk 1-3 orang, 15 menit sesi, 1 print 4R", price: "Rp 40.000" },
      { name: "Aurora", description: "Paket untuk 2-4 orang, 15 menit sesi, 2 print 4R", price: "Rp 50.000" },
      { name: "Eclipse", description: "Paket untuk 3-6 orang, 15 menit sesi, 3 print 4R", price: "Rp 65.000" },
      { name: "Orion", description: "Paket untuk 4-8 orang, 15 menit sesi, 4 print 4R", price: "Rp 85.000" },
    ],
  ...
  },
  {
    ...
    subPackages: [
      { name: "Simple", description: "Foto personal 1 orang, 1 background, Soft File only", price: "Rp 35.000" },
      { name: "Standard", description: "Foto personal 1 orang, 1 background, Print 3x4 (3), Print 4x6 (3)", price: "Rp 40.000" },
      { name: "Komplit", description: "Foto personal 1 orang, 1 background, Print 2x3 (6) ,Print 3x4 (5), Print 4x6 (5)", price: "Rp 70.000" },
      { name: "Nikah", description: "Foto 2 orang, 1 background, Print 2x3 (6) / orang , Print 3x4 (5) /orang , Print 4x6 (5) /orang", price: "Rp 130.000" },
    ],

     additionals: [
      { name: "Edit BW", price: "Rp 10.000" },
      { name: "Edit Background", price: "Rp 10.000" },
      { name: "Pas Foto berdua", price: "Rp 20.000" },
      { name: "Print Foto berdua", price: "Rp 10.000" },
      { name: "Print 4R", price: "Rp 10.000" },
      { name: "Print Foto A4", price: "Rp 30.000" },
    ],
