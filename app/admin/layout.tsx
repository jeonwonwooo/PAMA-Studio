      ...
      <aside className="w-64 bg-[#8B1A1A] text-white flex flex-col shadow-lg flex-shrink-0 z-20">
        ...
        <div className="p-4 border-t border-[#6B1212] flex-shrink-0">
          ...
          <button
            ...
            className="flex items-center gap-2 w-full px-4 py-2 text-red-100 hover:bg-[#6B1212] rounded-lg transition-colors"
          >
            <LogOut size={18} />
            <span>Logout</span>
          </button>
          ...
          <div className="flex items-center gap-4">
            ...
            {ready && (
              <div className="flex items-center gap-2">
                <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[#8B1A1A] text-white text-xs font-bold">
                  {userInitials}
                </div>
